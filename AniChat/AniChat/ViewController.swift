...
//              let chat = MostRecentViewController()
//              self.navigationController?.pushViewController(chat, animated: true)
      ...
      func makeSegmentControl() {
          ...
          let segmentConstraint = [
              loginSegmentControl.centerXAnchor.constraint(equalTo: view.centerXAnchor),
              loginSegmentControl.bottomAnchor.constraint(equalTo: containerView.topAnchor, constant:  -12),
              loginSegmentControl.widthAnchor.constraint(equalTo: containerView.widthAnchor),
              loginSegmentControl.heightAnchor.constraint(equalToConstant: 50)
          ]
          NSLayoutConstraint.activate(segmentConstraint)
